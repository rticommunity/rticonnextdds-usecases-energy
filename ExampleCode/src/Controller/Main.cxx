...
const string OptimizerID = "SampleOpt";
const string InterconnectID = "SampleInterconnect";
const string VizID = "Visualizer";
const int32_t default_strength = 1000;
...
int main(int argc, char* argv[])
{
    ...
    try {
        string entityName("Controller-" + OptimizerID);

        auto controller = new Controller(domainId, entityName);

        thread executeThread(&Controller::ExecuteController, controller, OptimizerID, InterconnectID, VizID);

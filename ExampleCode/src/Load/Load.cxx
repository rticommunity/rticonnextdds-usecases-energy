...
float SimMeasurement = 0.0;
bool connected = true;
std::string DeviceID = "SampleLoad";
std::string NodeID = "003";
float MaxLoad = -10.0;
float MaxGeneration = 0.0;
...
void publisher_main(int domain_id)
{
    ...
    rti::core::policy::EntityName entityName("Load-" + DeviceID);
    ...
    // Set the ownership strength of the Control Power to 0 to start with
    ...
    // Query Condition for Load level. This is used in the context of
    // simulation, but could be used for a controllable load

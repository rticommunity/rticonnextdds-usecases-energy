...
- **Control_Irradiance**: Used to provide an irradiance instance if no other device is doing so.

### Subscribed Topics

- **Control_Power**
- **Control_Device**
- **Control_Irradiance**: Wholly for simulation. In a real system this is environmentally dependent.
